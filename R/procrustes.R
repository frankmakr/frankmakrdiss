...
#'
#' @param x_mat A numerical matirix representing the MDS target configuration
#' @param y_mat A numerical matrix representing the MDS configuration
#'   to be compared
#' @param dilation A logical indicator for implementing optional scaling
#'   which defaults to `dilation = FALSE`
#' @return A numerical matrix representing the transformed MDS configuration
#' @export
