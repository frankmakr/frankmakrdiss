kvarven2020 <- list(
  eff_orig = c(0.496, 0.57, 0.459, 0.127, 0.877, 0.31, 0.676, 0.57, 0.31, 0.236,
    0.62, 0.117, 0.2, 0.3541, 0.426),
...
hillery1955 <- list(N = 94, n_konz = 16, n_combn = 22, sozint = 91, gemverb = 73, geo = 69)
...
halamova2018 <- list(
  ...
  exloadings_rc = matrix(
    c(0.844, 0.053, 0.334, 0.177, 0.059, 0.714, 0.109, 0.865, 0.805,
        0.028, 0.228, 0.093, 0.536, 0.852, 0.039, 0.732, 0.011, 0.223,
	0.485, 0.229, 0.693, 0.577,
      0.113, 0.273, 0.018, 0.535, 0.667, 0.104, 0.476, 0.064, 0.030,
        0.058, 0.194, 0.730, 0.036, 0.041, 0.839, 0.071, 0.828, 0.174,
        0.036, 0.582, 0.165, 0.166,
      0.012, 0.026, 0.407, 0.198, 0.214, 0.135, 0.112, 0.068, 0.076,
        0.459, 0.582, 0.096, 0.250, 0.079, 0.049, 0.119, 0.043, 0.453,
        0.125, 0.171, 0.147, 0.126),
    ncol = 3,
    dimnames = list(
      c("RC01", "RC02", "RC03", "RC04", "RC05", "RC06", "RC07", "RC08", "RC09",
	  "RC10", "RC11", "RC12", "RC13", "RC14", "RC15", "RC16", "RC17", "RC18",
	  "RC19", "RC20", "RC21", "RC22"),
      c("acc", "dyn", "opn"))
    ),
  exloadings_ic = matrix(
    c(0.959, 0.042, 0.019, 0.041, 0.088, 0.938, 0.110, 0.950, 0.932,
        0.086, 0.092, 0.032, 0.860, 0.955, 0.060, 0.683, 0.025, 0.151,
	0.737, 0.181, 0.861, 0.867,
      0.098, 0.362, 0.075, 0.607, 0.543, 0.035, 0.570, 0.013, 0.014,
        0.009, 0.077, 0.547, 0.061, 0.046, 0.792, 0.022, 0.863, 0.095,
        0.026, 0.530, 0.113, 0.102,
      0.066, 0.150, 0.756, 0.320, 0.119, 0.092, 0.318, 0.039, 0.035,
        0.390, 0.855, 0.286, 0.078, 0.038, 0.076, 0.037, 0.072, 0.738,
        0.069, 0.149, 0.001, 0.001),
    ncol = 3,
    dimnames = list(
      c("IC01", "IC02", "IC03", "IC04", "IC05", "IC06", "IC07", "IC08", "IC09",
